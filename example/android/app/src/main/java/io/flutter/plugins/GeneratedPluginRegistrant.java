...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.loucheindustries.pdf_annotations.PdfAnnotationsPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin pdf_annotations, com.loucheindustries.pdf_annotations.PdfAnnotationsPlugin", e);
    }
  }
}
